...
def get_vector_store(text_chunks):
    embeddings = GoogleGenerativeAIEmbeddings(model="models/embedding-001",google_api_key="AIzaSyAgtA7BM1lO2ZeAPQx527Ydgbs3SLXWuJQ")
...
def get_conversational_chain():
    ...
    Answer:
    """
    model=ChatGoogleGenerativeAI(model="gemini-1.5-flash-latest",temperature=0.3,google_api_key="AIzaSyAgtA7BM1lO2ZeAPQx527Ydgbs3SLXWuJQ")
